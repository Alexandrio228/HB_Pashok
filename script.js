...
const stages = [
  ...
  },
  {
    ...
    fragment: 'd_',
    feedback: `✅ <strong>Верно!</strong><br>
      Не переживай — ты хоть теперь и дед, но ты очень крутой дед,<br>
      который прошёл 10 лет дружбы и ни разу не удалил меня из контактов.<br>
      Даже в ЧС ни разу не кинул, несмотря на то, что в какой-то момент, ты заблокировал всех из Супер Мишек.💩😈<br><br>
  ...
  },
  {
    ...
    fragment: 'sh',
    feedback: `✅ <strong>Верно!</strong><br>
      Это очень крутое и интересное хоби — особенно когда клюёт. Всё ещё жду, когда ты приедешь за форелью, она там уже во всю метает икру.<br><br>
  ...
  },
  {
    ...
    fragment: 'ul',
    feedback: `✅ <strong>Верно!</strong><br>
      ЧтоЖЖЖЖЖ......Ты реально крутой программист, решил все задачки по программированию.
      <br>Можешь сообщить об этом Артёму, глядишь, он уступит тебе своё место за это😉😁<br>
  ...
  },
  {
    ...
    feedback: `✅ <strong>Верно!</strong><br>
      ...
      De facto — ты мой друг, который дружит со мной вот уже 10 лет, ты прошёл ВСЕ испытания, осталось только финальное задание - собрать все фрагменты воедино.<br>
