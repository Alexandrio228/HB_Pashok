...
const stages = [
  ...
  },
  {
    ...
    fragment: 'd_',
    feedback: `✅ <strong>Верно!</strong><br>
      Не переживай — ты хоть и теперь и дед, но ты очень крутой дед,<br>
      который прошёл 10 лет дружбы и ни разу не удалил меня из контактов.<br>
      Даже в ЧС ни разу не кинул, несмотря на то, что в тот момент, ты заблокировал всех из Супер Мишек.💩😈<br><br>
